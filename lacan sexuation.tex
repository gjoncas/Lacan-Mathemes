...
%To Do:	tweak 'cancel' parameters, fix arrows; add different translations; make a color version
%try out \reflectbox{E}
...
\node (A) at (3,0.8) 	{$a$};
\node (L) at (4.55,0.8) {\cancel{\textit{La}}};
...
\node (L) at (5.4,1.1)  {{\Large \cancel{\textit{La}}}};
